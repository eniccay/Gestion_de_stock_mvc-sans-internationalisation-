	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message key="common.nouveau.fournisseur" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                <div class="col-lg-12">
					...
					<fmt:message key="fournisseur.formulaire"/>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                        <c:url value="/fournisseur/enregistrer" var ="urlEnreister"/>
                            <f:form  modelAttribute="fournisseur"  action="${urlEnreister}" methode="post" enctype="multipart/form-data">
