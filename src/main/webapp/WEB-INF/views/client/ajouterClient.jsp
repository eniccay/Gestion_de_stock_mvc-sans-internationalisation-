	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message key="common.nouveau.client" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                <div class="col-lg-12">
					...
					<fmt:message key="client.formulaire"/>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                        <c:url value="/client/enregistrer" var ="urlEnreister"/>
                            <f:form  modelAttribute="client"  action="${urlEnreister}" methode="post" enctype="multipart/form-data">
