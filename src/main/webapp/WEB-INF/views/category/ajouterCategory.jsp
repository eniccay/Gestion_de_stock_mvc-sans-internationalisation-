	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message key="common.nouveau.category" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                <div class="col-lg-12">
					...
					<fmt:message key="category.formulaire"/>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                        <c:url value="/category/enregistrer" var ="urlEnreister"/>
                            <f:form  modelAttribute="category"  action="${urlEnreister}" methode="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label> <fmt:message  key="category.designiation" /></label>
