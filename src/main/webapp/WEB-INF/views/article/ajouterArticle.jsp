	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-lg-12">
						<h1 class="page-header"><fmt:message key="common.nouveau.article" /></h1>
					</div>
					<!-- /.col-lg-12 -->
				</div>
				<div class="row">
                <div class="col-lg-12">
					...
					<fmt:message key="article.formulaire"/>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                        <c:url value="/article/enregistrer" var ="urlEnreister"/>
                            <f:form  modelAttribute="article"  action="${urlEnreister}" methode="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label> <fmt:message  key="common.prixUnitaireHT" /></label>
                                 <f:input id="prixUnitaireHT" path="prixUnitaireHT" class="form-control" placeholder="PrixUnitaireHT"/>
                              </div>
                              
                              <div class="form-group">
                                <label> <fmt:message  key="common.tva" /></label>
                                 <f:input id="tva" path="tva" class="form-control" placeholder="Tva"/>
                              </div>
                              
                              <div class="form-group">
                                <label> <fmt:message  key="common.prixUnitaireTTC" /></label>
                                 <f:input id="prixUnitaireTTC" path="prixUnitaireTTC" class="form-control" placeholder="PrixUnitaireTTC"/>
                              </div>
                              ...
                              <div class="form-group">
                                <label> <fmt:message  key="common.category" /></label>
                                 <f:select class="form-control" path="category.idCategory" items="${categorys}" itemLabel="code" itemValue="idCategory"/>
                              </div>
